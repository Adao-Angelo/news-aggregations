...
interface SignInModalProps {
  ...
  setSignInModalIsOpen: (value: React.SetStateAction<boolean>) => void;
}
      ...
      <div className="overflow-scroll h-[60rem] p-5">
        <div className="bg-white rounded-[0.6rem] py-[4.2rem] px-[3.2rem] w-[40rem]">
          ...
          <p className="text-[1.3rem] mt-[1.6rem] text-grayDark">
            Log in now to enjoy a great experience.
          </p>
          ...
          <form onSubmit={handleSubmit}>
            <div className="mt-[4.2rem]">
              <label className="text-[1.2rem]" htmlFor="signin-email">
                Your email
              </label>
              <input
                id="signin-email"
            ...
            <div className="mt-[2rem]">
              <label className="text-[1.2rem]" htmlFor="signin-password">
                Your password
              </label>
              <input
                id="signin-password"
